...
export const translations = {
  en: {
    ...
    hero: {
      ...
      desc: "We build premium websites and SaaS platforms for businesses and entrepreneurs.",
    ...
    estimator: {
      ...
      labelPrivacy: "I accept the privacy policy and authorize Kyros Studio to process my contact details.",
      errorPrivacy: "You must accept the privacy policy to continue.",
  ...
  fr: {
    ...
    hero: {
      ...
      desc: "Nous créons des sites web et des SaaS pour les entreprises et les entrepreneurs.",
    ...
    estimator: {
      ...
      labelPrivacy: "J'accepte la politique de confidentialité et j'autorise Kyros Studio à traiter mes données de contact.",
      errorPrivacy: "Vous devez accepter la politique de confidentialité pour continuer.",
      namePlaceholder: "Sarah Connor",
      emailPlaceholder: "sarah@skynet.io",
